 ...
 * Desktop dock is positioned fixed at the bottom; mobile uses a
 * collapse-to-button menu anchored bottom-right.
 **/
            ...
            {items.map((item, idx) => (
              ...
              >
                <Link
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-900 border border-white/10"
                >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        // overflow-visible so magnified icons and their tooltips aren't clipped
        "liquid-glass mx-auto hidden h-16 items-end gap-4 overflow-visible rounded-2xl px-4 pb-3 md:flex",
        className,
      )}
    >
      {items.map((item) => (
